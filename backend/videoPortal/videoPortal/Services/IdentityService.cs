...
namespace videoPortal.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        private readonly videoPortalDbContext _context;

        public IdentityService(UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters, videoPortalDbContext context)
        {
